...
monthBackground = "#8C1229";        // Background colour of month strap
...
dateBackground = "#f3eecb";         // Background colour of full date cells
...
weekendBackground = "#f3eecb";      // Background colour of full date cells
...
offBackground = "#FCFAEB";          // Background colour of full date cells
...
function getRCCalendar(year,month,item){
  ...
  if(scrollingMonth==1){
  	doCalc+='<td><a class="monthhead" href="javascript:void(0)" onClick="getRCCalendar('+year+','+(month-1)+','+item+')">'+minusSymbol+'<\/a><\/td>';}
...
/*Es la misma función que doRCCalendar, con la salvedad de que recibe como parámetro una cadena
